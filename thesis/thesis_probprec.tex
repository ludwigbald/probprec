...
A Singularity container was set up on Ubuntu 16.4 LTS with python 3.5, pytorch (version) and DeepOBS (see Appendix for Singulariy recipe\todo{append recipe}).
...
\todo{Mention Adam/Momentum. Maybe in the DeepOBS paper?}
...
\todo{Add new version using bs 32, explain results}
\todo[inline]{rearrange figure into 2x2}
\begin{figure}
	\centering \hspace{-1,5cm}
...
\todo[inline]{So estimating the Hessian with B=128 costs the same as 2 epochs of sgd? Or is it referring to applying the preconditioner over an epoch. The latter makes sense but can be remedied and is why it should rather be compared to adam in cost.}
