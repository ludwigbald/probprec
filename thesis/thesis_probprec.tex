...
Computing the true Hessian is very hard and expensive in the high-dimensional and noisy deep learning setting, so various approximations have been studied. \todo{maybe cite}

Convergence speed depends on the \textit{condition number} $\kappa = \frac{\lambda_n}{\lambda_1}$ of the Hessian.\todo{cite Saad, "Numerical Optimization"}
...
\todo{introduction to this chapter: - The algorithm was proposed, I re-implemented it, some things were improved and changed by that. The experiments were run on TCML}
...
\section{Discussion} % Important stuff first - neat details last.
