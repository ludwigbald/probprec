...
In parallel with this thesis, a pyTorch version of DeepOBS was being developed by Aaron Bahde. Another contribution was to provide user feedback to the development team of DeepOBS. \todo{some of the feedback is found where in the thesis?} This development is described in detail in \todo{cite Aarons MA}
