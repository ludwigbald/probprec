...
\todo[inline]{DONE: run AdaptiveSGD and PreconditionedSGD on 9 more seeds on the problems}
\todo[inline]{Plot and describe findings}
...
\todo[inline]{DONE: Run runtime-estimation for AdaptiveSGD and PreconditionedSGD and OnlyAdaptiveSGD for a few problems}
\todo[inline]{Report results: OnlyAdaptiveSGD=SGD < AdaptiveSGD < PreconditionedSGD}
...
\todo[inline]{DONE: monkey patch an uninitialized testproblem into deepobs}
\todo[inline]{DONE: run PreconditionedSGD without lr, with and without initialization, on 10 seeds for 5 epochs, only cifar10}
\todo[inline]{RUNNING: Batch size 64}
...
\todo[inline]{DONE: run PreconditionedSGD without lr on cifar10 and fmnist, see preconditioning}
...
\todo[inline]{probably not i guess}
