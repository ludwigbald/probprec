...
\usetheme[faculty=fi]{fibeamer} %%with modified sources!
\usepackage[utf8]{inputenc}
\usepackage[main=english, ngerman]{babel}        %% typeset as follows:
%%
%%   \begin{otherlanguage}{czech}   ... \end{otherlanguage}
%%   \begin{otherlanguage}{slovak}  ... \end{otherlanguage}
%%

% use this to display notes
\usepackage{pgfpages}
%	\setbeameroption{show notes on second screen = right}

%% These macros specify information about the presentation
\title{Bachelor Thesis Presentation} %% that will be typeset on the
\subtitle{Evaluating Probabilistic Preconditioning using DeepOBS} %% title page.
\author{Ludwig Bald}
