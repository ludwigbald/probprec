...
performance_dic = analyzer.get_performance_dictionary('./baselines/fmnist_2c2d/SGD')
print(performance_dic)

performance_dic = analyzer.get_performance_dictionary('./baselines/cifar10_3c3d/SGD')
print(performance_dic)
